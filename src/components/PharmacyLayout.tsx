...
const menuItems = [
  ...
  { icon: ShoppingCart, label: "Orders", path: "/pharmacy/orders" },
  { icon: Package, label: "Inventory", path: "/pharmacy/inventory" },
  { icon: Pill, label: "Drug Reports", path: "/pharmacy/drug-reports" },
  { icon: BarChart3, label: "Analytics", path: "/pharmacy/analytics" },
];
...
const PharmacyLayout = ({ children, title }: PharmacyLayoutProps) => {
          ...
          <Link to="/pharmacy/dashboard" className="flex items-center gap-3">
            ...
            {sidebarOpen && (
              <div className="flex flex-col">
                ...
                <span className="text-xs text-sidebar-foreground/70">Pharmacy</span>
              </div>
            )}
          </Link>
          <Button
          ...
          <div className="mx-3 mb-3 p-3 rounded-lg bg-sidebar-accent/50 border border-sidebar-border">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-sidebar-foreground truncate">Pharmacy Admin</p>
                <p className="text-xs text-sidebar-foreground/70">Pharmacy Manager</p>
              </div>
            </div>
          </div>
        )}
