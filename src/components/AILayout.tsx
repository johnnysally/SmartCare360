...
const menuItems = [
  { icon: LayoutDashboard, label: "Dashboard", path: "/ai/dashboard" },
          ...
          <Link to="/ai/dashboard" className="flex items-center gap-3">
            ...
            {sidebarOpen && (
              <div className="flex flex-col">
                ...
                <span className="text-xs text-sidebar-foreground/70">AI Analytics</span>
              </div>
            )}
          </Link>
          <Button
          ...
          <div className="mx-3 mb-3 p-3 rounded-lg bg-sidebar-accent/50 border border-sidebar-border">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-sidebar-foreground/70">AI Systems</p>
              </div>
            </div>
          </div>
        )}
