...
const DoctorLayout = ({ children, title }: DoctorLayoutProps) => {
          ...
          <Link to="/doctor/dashboard" className="flex items-center gap-3">
            ...
            {sidebarOpen && (
              <div className="flex flex-col">
                ...
                <span className="text-xs text-sidebar-foreground/70">Doctor Portal</span>
              </div>
            )}
          </Link>
          <Button
          ...
          <div className="mx-3 mb-3 p-3 rounded-lg bg-sidebar-accent/50 border border-sidebar-border">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-sidebar-foreground truncate">Dr. Sarah Kimani</p>
                <p className="text-xs text-sidebar-foreground/70">General Practitioner</p>
              </div>
            </div>
          </div>
        )}
