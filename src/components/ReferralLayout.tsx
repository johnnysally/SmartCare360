...
const menuItems = [
  { icon: LayoutDashboard, label: "Dashboard", path: "/referral/dashboard" },
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-sidebar-border">
          <Link to="/referral/dashboard" className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-sidebar-primary flex items-center justify-center shrink-0">
              <Share2 className="w-6 h-6 text-sidebar-primary-foreground" />
            </div>
            {sidebarOpen && (
              <div className="flex flex-col">
                ...
                <span className="text-xs text-sidebar-foreground/70">Referrals</span>
              </div>
            )}
          </Link>
          <Button
          ...
          <div className="mx-3 mb-3 p-3 rounded-lg bg-sidebar-accent/50 border border-sidebar-border">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-sidebar-foreground/70">Partner Relations</p>
              </div>
            </div>
          </div>
        )}
