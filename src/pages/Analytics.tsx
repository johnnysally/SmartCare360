    ...
    <div className="space-y-6 animate-fade-in">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          ...
          { label: "Appointments", value: "1,234", change: "+8%", icon: Calendar },
          { label: "Revenue", value: "KES 4.2M", change: "+15%", icon: TrendingUp },
          { label: "Avg Wait Time", value: "18 min", change: "-5%", icon: BarChart3 },
        ].map((stat, i) => (
          <Card key={i}>
